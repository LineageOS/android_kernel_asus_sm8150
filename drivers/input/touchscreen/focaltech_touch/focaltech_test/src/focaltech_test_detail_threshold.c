...
int malloc_struct_DetailThreshold(void)
{
    ...
    if (NULL == g_stCfg_MCap_DetailThreshold.SITORawdata_RxLinearityTest_Base) goto ERR;

    g_stCfg_MCap_DetailThreshold.SITORawdata_TxLinearityTest_Base = (int (*)[RX_NUM_MAX])fts_malloc(NUM_MAX*sizeof(int));
    if (NULL == g_stCfg_MCap_DetailThreshold.SITORawdata_TxLinearityTest_Base) goto ERR;
    ...
    g_stCfg_MCap_DetailThreshold.LCDNoistTest_Coefficient = (int (*)[RX_NUM_MAX])fts_malloc(NUM_MAX*sizeof(int));
    if (NULL == g_stCfg_MCap_DetailThreshold.LCDNoistTest_Coefficient) goto ERR;
...
void free_struct_DetailThreshold(void)
{
    ...
    {
        fts_free(g_stCfg_MCap_DetailThreshold.LCDNoistTest_Coefficient);
        g_stCfg_MCap_DetailThreshold.LCDNoistTest_Coefficient = NULL;
    }
