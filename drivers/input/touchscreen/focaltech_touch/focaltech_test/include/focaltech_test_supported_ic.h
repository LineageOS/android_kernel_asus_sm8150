...
struct stCfg_FT8716_BasicThreshold
{
    ...
    bool bLcdBusyAdjust;
    bool bShortCircuit_VA_Check;
    bool bShortCircuit_VKey_Check;
    //int ShortCircuit_ResMin;
    int ShortCircuit_VA_ResMin;
    int ShortCircuit_Key_ResMin;
    int OpenTest_CBMin;
    ...
    int vk_key_right[8];
    int vk_key_bottom[8];
    bool vk_threshold_Dynamic;
    bool vk_touch_threshold_incell[2];
    int vk_div_number_incell[2];
    int vk_preserved_threshold[2];
    
    int KEYShortTest_K1_Value;  //lwg
    int KEYShortTest_CB_Max;
};
enum enumTestItem_FT8716
{
    ...
    Code_FT8716_VIRTUAL_KEY_TEST,
    Code_FT8716_RF_VK_TEST,
    CODE_FT8716U_KEY_SHORT_TEST,
